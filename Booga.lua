...
local autohealToggle = healtab.new("Switch", {text="Legit Autoheal"})
local autohealSlider = healtab.new("Slider", {text="auto heal health", min=1, max=100, value=30})
local autohealToggle = healtab.new("Switch", {text="Rage Autoheal (Risky)"})
local autohealSlider = healtab.new("Slider", {text="auto heal health", min=50, max=500, value=100})
